# Contributing to donejs-xterm

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/imaustink/donejs-xterm) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork donejs-xterm, you can start by going to its [fork page](https://github.com/imaustink/donejs-xterm/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/donejs-xterm
```
